...
## agent
- https://github.com/link-assistant/agent -tool agent с бесплатной моделью Grok Code Fast 1. [grok-4.1-fast](https://openrouter.ai/x-ai/grok-4.1-fast) - больше не работает

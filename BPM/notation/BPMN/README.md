...
### gost
- ISO/IEC 19510:2013 Информационные технологии. Модель и нотация процесса менеджмента объекта в групповом бизнесе Information technology -- Object Management Group Business Process Model and Notation https://www.gostinfo.ru/catalog/Details/?id=5310784
### BPMN Concepts
...
- [Сказочная нотация BPMN и как её применять](https://habr.com/ru/articles/838976/) + схема EPC
...
### llm
- https://habr.com/ru/articles/968016/
### вопросы
- Сколько всего типов начальных событий определяет BPMN 2.0?
Во всех описаниях bpmn одна и та же табличка с тремя под-колонками стартовые события. Из нее ответ будет:
7/9/7/23. 

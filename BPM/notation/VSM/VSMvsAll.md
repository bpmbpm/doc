...
Боден пишет живо, приводит интересные детали и ссылки на другие источники, так что материал легко усваивается. Если после прочтения останутся вопросы по каким-то деталям — спрашивай, разберу! [```14```](https://projectproduction.org/journal/operations-science-view-of-value-stream-mapping/)[```17```](https://www.scoop.it/topic/tls-toc-lean-six-sigma/p/4149923914/2023/12/30/where-do-value-stream-maps-come-from-article-by-michel-baudin)

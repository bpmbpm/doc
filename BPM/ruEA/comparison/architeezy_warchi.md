...
Enterprise Architecture tools, Open Source (architeezy - добавлен "авансом" - в надежде "на лучшее \ светлое - открытое \ свободное").   Некоторые указанные инструменты не на 100% Open Source, но все free.   

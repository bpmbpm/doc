...
В рамках BPM может быть внедрена хорошая Business activity monitoring (BAM), которая лишь покажет, что процессы исполняются плохо. При этом в отсутвии BAM сами процессы могут быть идеальными и не требующими совершенствования. 

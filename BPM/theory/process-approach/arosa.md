...
- [Предмет исследования (анализа)](Оценка проекта внедрения Процессного подхода концепции самого Процессного подхода) в контексте обсуждения https://github.com/bpmbpm/doc/new/main/BPM/theory/process-approach

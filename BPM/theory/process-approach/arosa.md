...
- Автор анализа Владимир. Дисклеймер:  
  ...
  - нет цели НИКОГО задеть или обидеть. Цель комментария -  показать работу своей т.з. на этом конкретном проекте (как я по-другому вижу и провожу аналогичные  работы).

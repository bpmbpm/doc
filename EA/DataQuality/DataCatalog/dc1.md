...
### 1.1 term
- Data Lineage В анализе данных (Data Lineage)
  - В сфере IT термин используется как «родословная данных». Это процесс отслеживания полного пути информации — от ее изначального источника через все базы данных и преобразования (трансформации) до финального отчета.  

...
- [Data Lineage из топора](https://habr.com/ru/articles/836648/)
### bok 
- Конспект DAMA DMBOK2 на русском языке [Глава 12 Управление метаданными](https://dataliteracy.ru/dmbok-notes-12)
- [Свод знаний по компетенции Управление данными](https://cdto.work/wp-content/uploads/2021/11/4.upravlenie-dannymi.pdf)
...
- [APQC Process Classification Framework (PCF) - Banking PCF - Excel Version 7.2.1](https://www.apqc.org/resource-library/resource-listing/apqc-process-classification-framework-pcf-banking-pcf-excel-2)
- [«Референтная модель BIAN» для банковской индустрии или как перестать изобретать велосипед](https://habr.com/ru/articles/427147/)

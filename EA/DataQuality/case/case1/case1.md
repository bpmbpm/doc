...
```mermaid
graph TD
    subgraph “DAMA DMBOK Wheel (фрагмент)”
        DQ[Качество данных<br>Data Quality]
        MDM[Управление мастер-данными]
        DW[Хранилище данных / BI]
        MD[Метаданные]
        DG[Управление данными]
    end

    subgraph “Состав DQ (процессы DMBOK)”
        DQ1[Определение требований к качеству]
        DQ2[Профилирование данных<br>Data Profiling]
        DQ3[Измерение качества<br>DQ Metrics / Scorecards]
        DQ4[Анализ корневых причин]
        DQ5[Очистка и обогащение]
        DQ6[Мониторинг и отчетность]
    end

    subgraph “Внешние зависимости DQ”
        SLA[Соглашения об уровне услуг<br>Data SLA / Service Levels]
        BDQ[Бизнес-глоссарий<br>Правила валидации]
        OPS[Управление инцидентами<br>ITIL / ServiceNow]
        RDM[Управление эталонными данными]
    end

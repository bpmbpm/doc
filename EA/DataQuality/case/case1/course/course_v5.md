## v5
Возвращаюсь к исходному сценарию, где главное действующее лицо — **сотрудник Финансово-аналитического управления (ФАУ)**. Ниже — **полностью переработанный курс**, унифицированный по роли (только ФАУ) и приближенный к исходному описанию сценария DM.DQ.C1.

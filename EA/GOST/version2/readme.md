...
- *Business model* Бизнес-модель, framework / шаблон деятельности (структура), например, интернет-магазин, Uber, франчайзи, маркетплейс и т.п.  
...
Бизнес-стратегия (стратегия долгосрочная \ краткосрочная), например, А) Создаем бизнес, можно даже убыточный, главное – легализация актива.  Б) демпингуем рынок -> разоряем конкурентов –> потом взвинчиваем цены Б) Продаем продукт ниже себестоимости, но зарабытываем на его поддержке и доработке. 

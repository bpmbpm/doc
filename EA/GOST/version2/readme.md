...
- *Business model* Бизнес-модель, framework / шаблон деятельности (структура), например, интернет-магазин, Uber и т.п.  
...
Бизнес-стратегия (стратегия долгосрочная \ краткосрочная), например, А) Создаем бизнес, можно даже убыточный, главное – легализация актива.  Б) демпингуем рынок -> разоряем конкурентов –> потом взвинчиваем цены. 

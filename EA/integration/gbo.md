...
#### example
GBO (Generic Business Object — обобщенный бизнес-объект) и ASBO (Application Specific Business Object — прикладной бизнес-объект) используются в интеграции систем для преобразования данных.  
ASBO — специфичный формат системы,  
GBO — промежуточный, единый формат.  
Пример: заказ из CRM (ASBO 1) превращается в GBO, затем в формат системы логистики (ASBO 2).

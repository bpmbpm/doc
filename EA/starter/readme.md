...
##### Не приемлемо   
Для стартового комплекта не рассматриваем (непримелемо):  
...
##### Приемлемо   
- что-то наподобие ARIS Express, но с открытым форматом файла. Т.е. системы 
- метод лицензирования EA \ BPM систем, где есть free с полным функционалом, но с ограничеснием не по времени, а, например, по числу используемых объектов. Например, бразильская BPM (250 объектов бесплатно). 

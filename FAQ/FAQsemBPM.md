...
Исполнялки – это Camunda, их продукт – исполняемый в BPMN-engine схема BPMN. Ранее были исполняемые UML, и даже сейчас еще работают, например, в [Runa WFE](https://habr.com/ru/articles/866822/). К схеме BPMN нужно конечно еще куча дополнительного кода на js\java и т.п., при этом все равно все это называют «low-code». К BPMN-engine еще мониторы исполнения, типа Cockpit. Для ARIS подобных систем ничего этого не нужно, т.к. ни выполнять ни кодировать не нужно.  

...
- От J.C. Penney до Nike: как бренды запускали провальные проекты изменений Истории Boeing, J.C. Penney, Ford, Kodak и других брендов наглядно показывают: амбициозные проекты изменений легко могут превратиться в дорогостоящий хаос. Какие ошибки этому поспособствуют, рассказывает Татьяна Морозова (Институт Тренинга)
- 

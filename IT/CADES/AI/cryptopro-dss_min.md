...
Нарисуй подробную схему (mermaid) взаимодействия всех компонент рассмотренного решения для двух вариантов с использованием КриптоПро DSS 2.0 https://cryptopro.ru/products/dss. 
...
В интерент в осномном описание настройки 1С.СЭД и КриптоПро CSP, но нам нужен DSS. Есть ссылка на [5.70 Электронная подпись сервиса DSS](https://its.1c.ru/db/bsp3111doc/content/2988/hdoc), но для чтения нужна учетка 1С:ИТС.  

...
### Вопрос 2
При использовании КриптоПро DSS 2.02 - подробно покажи взаимодействие КриптоПро CSP 5.0 на клиентском компьютере, включая протоколы взаимодействия. Можно ли на клиентском компьютере не КриптоПро CSP 5.0?

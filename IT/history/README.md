...
Смена ярлыков: Автоматизация –> Информатизация -> Цифровизация (АИЦ). Все это маркетинговые фишки. Для продаж нужны новые модные слова. ДиДжитализация, Цифровая трансформация, ГиперАвтоматизация и т.п. Смысл искатьне нужно это всего лишь "маркетинговое словоблудие" и желание хайпануть. Роботизация БП (RPA) vs автомализация БП BPA. Первое - это всего лищь про использование legacy (наследие), т.е. имеющегося ПО.    
...
Если говорить о чем-то, что отличается от АИЦ, то это механизация (предшедственник и идейный прототип) и реинжиниринг с лозункгом: "Не автоматизируй это!".

...
Смена ярлыков: Автоматизация –> Информатизация -> Цифровизация (АИЦ). Все это маркетинговые фишки консультантов: Для продаж им нужны новые модные слова. ДиДжитализация, Цифровая трансформация, ГиперАвтоматизация и т.п. Смысла искать в этих терминах не нужно, т.к. это всего лишь "маркетинговое словоблудие" и желание хайпануть. Роботизация БП (RPA) vs автомализация БП BPA. Первое - это всего лищь про использование legacy (наследие), т.е. имеющегося ПО.    

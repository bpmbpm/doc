...
- **Oracle Disclaimer** запрещает распространение данных за пределами Oracle без выполнения ряда условий (NDA, одобрение Systems Quality Office и т.д.).

Если нужно, могу построить марковскую модель для этой кластерной конфигурации или рассчитать чувствительность доступности к изменению failover time и MTBSI.

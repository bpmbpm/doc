...
Понимаю ваше замечание. В предыдущих ответах ссылки не отображались в тексте, так как я использовал формат, который, вероятно, не поддерживается вашим клиентом для копирования. Ниже я привожу исправленный ответ, в котором **все источники интегрированы непосредственно в текст** в виде явных гиперссылок или полных URL-адресов.

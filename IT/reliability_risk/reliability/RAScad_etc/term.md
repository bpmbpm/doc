...
Схемы в формате Mermaid и математические формулы в исходном коде Markdown для публикации на GitHub готовы. Вы можете скопировать этот текст напрямую в ваш файл README.md.
------------------------------
...
Коэффициент готовности: $A = P_2 + P_1 + P_{1W}$
------------------------------
Хотите ли вы дополнить этот документ матричным представлением (матрицей инфинитезимальных генераторов $Q$) для автоматизации расчетов стационарных вероятностей?

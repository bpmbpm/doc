...
Состояние S2_ fail является неработоспособным состоянием кластера. Для неработоспособных состояний добавляй окончание «_fail».

Переходы между состояниями:

- S0 → S1 — отказ одного из двух работоспособных узлов;
- S1 → S2_ fail — отказ оставшегося работоспособного узла;
- S1 → S0 — восстановление отказавшего узла;
- S2_ fail → S1 — восстановление одного из двух отказавших узлов.

## 2.1 Обозначения интенсивностей

## Unicode не содержит полного набора латинских подстрочных букв.
Получается, что μ₂₁ можешь, а для failover - только μ<sub>failover</sub> , т.к. Unicode не содержит полного набора латинских подстрочных букв.

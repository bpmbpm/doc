...
| $S_{0\_fail}$ | 0 | Оба узла отказали; один узел ремонтируется, второй ожидает ремонта | Неработоспособен |
...
|---|---|
| $S_2$ | $P_2 = \frac{1}{1 + 2\rho + 2\rho^2}$ |
| $S_1$ | $P_1 = \frac{2\rho}{1 + 2\rho + 2\rho^2}$ |
| $S_{0\_fail}$ | $P_0 = \frac{2\rho^2}{1 + 2\rho + 2\rho^2}$ |
...
|---|---|---:|
| $S_2$ | $P_2 = \frac{1}{D}$ | 0.9984012800 |
| $S_1$ | $P_1 = \frac{2\rho}{D}$ | 0.0015974420 |
| $S_{0\_fail}$ | $P_0 = \frac{2\rho^2}{D}$ | $1.2779536 \times 10^{-6}$ |

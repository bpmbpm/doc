...
Подставим $P_1 = \dfrac{2\lambda}{\mu} P_2$:
...
$$
K_{\mathrm{г,ст}} = \frac{1 + \dfrac{2\lambda}{\mu}}{D}
$$
...
D = 
1
+ \underbrace{\frac{2\lambda}{\mu}}_{D_1}
+ \underbrace{\frac{2\lambda(1 - \eta)}{\mu} \left(1 + \frac{\lambda}{\mu}\right)}_{D_2}
+ \underbrace{\frac{2\lambda_{tr}}{\mu_{tr}}}_{D_3}
+ \underbrace{\frac{2\lambda\lambda_{tr}}{\mu \mu_{tr}}}_{D_4}
+ \underbrace{\frac{2\lambda(1 - \eta)}{\theta} \left(1 + \frac{\lambda}{\mu}\right)}_{D_5}
+ \underbrace{\frac{2\lambda\eta}{\mu_{failover}}}_{D_6}
+ \underbrace{\frac{2\lambda}{\mu_{failback}}}_{D_7}
$$
...
- Отказы узлов считаются независимыми;

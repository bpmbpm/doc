...
Вы абсолютно правы. Я допустил терминологическую ошибку.

## Корректная формулировка

**50% — это не разница в коэффициентах готовности $K_{\text{г}}$, а относительный рост ненадёжности $U$.**

***

## Правильное сравнение $K_{\text{г}}$

| Модель | $K_{\text{г,ст}}$ | $U = 1 - K_{\text{г,ст}}$ |
|---|---|---|
| 8/2 (два узла) | **0.9999667266** | $3.32734 \times 10^{-5}$ |
| 12/3 (три узла) | **0.9999500606** | $4.99394 \times 10^{-5}$ |

### Разница в $K_{\text{г}}$ (абсолютная)

$$
\Delta K_{\text{г}} = K_{\text{г, 8/2}} - K_{\text{г, 12/3}} = 0.9999667266 - 0.9999500606 = 1.6666 \times 10^{-5}
$$

**Двухузловая модель имеет готовность выше на $1.67 \times 10^{-5}$ (абсолютно).**

### Относительная разница в $K_{\text{г}}$

$$
\frac{\Delta K_{\text{г}}}{K_{\text{г, 8/2}}} \times 100\% = \frac{1.6666 \times 10^{-5}}{0.9999667266} \times 100\% \approx 0.00167\%
$$

**Готовность двухузловой модели выше на 0.00167% (относительно).**

***

## Что означает 50%?

Это **относительный рост ненадёжности** $U$:

$$
\frac{U_{12/3} - U_{8/2}}{U_{8/2}} \times 100\% = \frac{4.99394 \times 10^{-5} - 3.32734 \times 10^{-5}}{3.32734 \times 10^{-5}} \times 100\% = 50.09\%
$$

**Трёхузловая модель имеет ненадёжность выше на 50% относительно двухузловой.**

***

## Корректные выводы для анализа

| Показатель | Значение |
|---|---|
| Абсолютная разница в $K_{\text{г}}$ | $1.67 \times 10^{-5}$ (8/2 лучше) |
| Относительная разница в $K_{\text{г}}$ | 0.00167% (8/2 лучше) |
| Относительный рост $U$ | **50%** (12/3 хуже) |
| Простой за год: 8/2 | 17.49 мин |
| Простой за год: 12/3 | 26.25 мин |
| **Дополнительный простой 12/3** | **+8.76 мин/год** |

***

## Исправленная формулировка для analysis.md

**Было (некорректно):**
> относительный рост ненадёжности при переходе от дублирования к троированию составил +44%

**Должно быть (корректно):**
> При переходе от дублирования к троированию ненадёжность $U$ возрастает на **50%** (с $3.33 \times 10^{-5}$ до $4.99 \times 10^{-5}$), что соответствует дополнительному простою **8.76 мин/год**. Абсолютная разница в коэффициенте готовности составляет $1.67 \times 10^{-5}$ в пользу двухузловой конфигурации.

***

Спасибо за замечание — 50% относится только к относительному изменению $U$, а не к разнице в $K_{\text{г}}$.

## 3

Вы правы, термин «ненадёжность» ($U$) в классической теории надёжности не используется как базовое понятие. Корректно говорить о **коэффициенте готовности** $K_{\text{г}}$ и **коэффициенте неготовности** (иногда обозначается $K_{\text{нг}}$ или $1 - K_{\text{г}}$).

Исправляю ответ.

***

## Корректное сравнение по $K_{\text{г}}$

| Модель | $K_{\text{г,ст}}$ | $1 - K_{\text{г,ст}}$ |
|---|---|---|
| 8/2 (два узла) | **0.9999667266** | $3.32734 \times 10^{-5}$ |
| 12/3 (три узла) | **0.9999500606** | $4.99394 \times 10^{-5}$ |
...
## Разница в коэффициенте готовности
...
**Двухузловая модель имеет коэффициент готовности выше на $1.67 \times 10^{-5}$ (абсолютно).**

### Относительная разница (уменьшение $K_{\text{г}}$)

$$
\frac{K_{\text{г, 8/2}} - K_{\text{г, 12/3}}}{K_{\text{г, 8/2}}} \times 100\% = \frac{1.6666 \times 10^{-5}}{0.9999667266} \times 100\% \approx 0.00167\%
$$

**Трёхузловая модель имеет коэффициент готовности ниже на 0.00167% относительно двухузловой.**

***

## Относительное изменение коэффициента неготовности

Коэффициент неготовности: $K_{\text{нг}} = 1 - K_{\text{г}}$

| Модель | $K_{\text{нг}}$ |
|---|---|
| 8/2 | $3.32734 \times 10^{-5}$ |
| 12/3 | $4.99394 \times 10^{-5}$ |

Относительное изменение:

$$
\frac{K_{\text{нг, 12/3}} - K_{\text{нг, 8/2}}}{K_{\text{нг, 8/2}}} \times 100\% = \frac{4.99394 \times 10^{-5} - 3.32734 \times 10^{-5}}{3.32734 \times 10^{-5}} \times 100\% = 50.09\%
$$

**Коэффициент неготовности трёхузловой модели на 50% выше, чем у двухузловой.**

***

## Корректные выводы для analysis.md

| Показатель | Значение |
|---|---|
| $K_{\text{г, 8/2}}$ | 0.9999667266 |
| $K_{\text{г, 12/3}}$ | 0.9999500606 |
| **Абсолютная разница $K_{\text{г}}$** | **$1.67 \times 10^{-5}$** (8/2 лучше) |
| **Относительное снижение $K_{\text{г}}$** | **0.00167%** (12/3 хуже) |
| Коэффициент неготовности: 8/2 | $3.33 \times 10^{-5}$ |
| Коэффициент неготовности: 12/3 | $4.99 \times 10^{-5}$ |
| **Относительный рост $K_{\text{нг}}$** | **50%** (12/3 хуже) |
| Простой за год: 8/2 | 17.49 мин |
| Простой за год: 12/3 | 26.25 мин |
| **Дополнительный простой 12/3** | **+8.76 мин/год** |
...
> При переходе от дублирования к троированию коэффициент готовности снижается на $1.67 \times 10^{-5}$ (абсолютно) или на 0.00167% (относительно). Коэффициент неготовности при этом возрастает на 50% (с $3.33 \times 10^{-5}$ до $4.99 \times 10^{-5}$), что соответствует дополнительному простою 8.76 мин/год.

***

Спасибо за замечание — корректно говорить о **коэффициенте готовности** $K_{\text{г}}$ и **коэффициенте неготовности** $1 - K_{\text{г}}$, а не о «ненадёжности».

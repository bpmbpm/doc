...
- [Эпоха «белых списков»: почему ваши конфиги в декабре 2025 года начали превращаться в тыкву, и что нас ждет…](https://habr.com/ru/articles/979128/)
...
- [Отправим стукачей в ГУЛАГ](https://habr.com/ru/articles/1022390/) ; [Строим VPN, устойчивый к SpyWare](https://habr.com/ru/articles/1022586/)
### Amnezia
...
- info
  - [Книги по веб-хакингу](https://habr.com/ru/articles/1069254/) 
### TOR
...
- [Повышаем стабильность Telegram: поднимаем партизанский MTProxy с Fake TLS](https://habr.com/ru/articles/994934/)
- [РКН и «сибирская блокировка»](https://habr.com/ru/articles/1010336/)
### WhatsApp etc
...
#### alternative
- [После блокировки мессенджеров Matrix стал единственной альтернативой?](https://habr.com/ru/companies/ruvds/articles/1009268/) ; [wiki](https://ru.wikipedia.org/wiki/Matrix) ; [serverless](https://habr.com/ru/companies/ruvds/articles/1009268/#comment_29658512)
### Audio
- [Радар для прослушки телефона с трёх метров](https://habr.com/ru/companies/globalsign/articles/974230/) Сейчас на рынке полно радарных датчиков присутствия человека. Миниатюрное батарейное устройство. Работают они на частотах  5.8 ГГц, 10ГГц, 24ГГц, 60ГГц а иногда на более высоких частотах 77 ГГц и выше.
Так что с наличием миллиметрового радара в квартире проблем нет.

### соц-инженерия
- [Это не развод: как выглядит современная атака социальной инженерии через «рабочий чат»](https://habr.com/ru/articles/977952/)

### decentralization
- [Есть к примеру децентрализованный мессенджер Tox, который вообще не имеет серверов](https://habr.com/ru/articles/1003244/#comment_29580390)

### VLESS
- [Из-за критической уязвимости VLESS клиентов скоро все ваши VPN будут заблокированы](https://habr.com/ru/articles/1020080/)
### authorization
- [Рунет без Google Login: что теперь делать с авторизацией](https://habr.com/ru/articles/1053664/) закон № 199-ФЗ от 26.06.2026, который добавил в КоАП штрафы за нарушение правил авторизации пользователей. https://www.consultant.ru/document/cons_doc_LAW_537878/
### 2
- [Смартфон-шпион: почему даже отключение интернета не мешает смартфону отправлять хакерам данные](https://habr.com/ru/companies/solarsecurity/articles/1080794/)

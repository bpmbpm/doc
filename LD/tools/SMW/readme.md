...
- https://habr.com/ru/articles/947566/#comment_28850324 Тыкаю палкой XWiki что лежат в сети

### hosting
- https://www.pro.wiki/semantic-mediawiki-hosting
- [sandbox](https://sandbox.semantic-mediawiki.net/wiki/Main_Page)
### base
- хабр [Semantic MediaWiki](https://habr.com/ru/articles/173877/)

### 2
- 2019 [Создание связанных данных библиотек с помощью Wikibase: уроки, извлеченные из проекта Passage](https://www.researchgate.net/publication/334971781_Creating_Library_Linked_Data_with_Wikibase_Lessons_Learned_from_Project_Passage#pf14)
- [Семантическая MediaWiki против Wikibase против Cargo](https://professional.wiki/en/articles/managing-data-in-mediawiki#)

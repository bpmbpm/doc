...
Он один раз мелькнул в одном гос-учереждении Японии. Год-два с ним экспериментировали и забросили.
Prolog - это не язык общего назначения, хотя он и turing-complete. Но он очень лаконичен и удобен в использовании в узких проблемных областях, например там, где есть частично-структурированные данные.
Есть еще категория функциональных языков, которые значительно более популярны, чем логические языки. Но работу со знанием Haskell, например, вы тоже вряд ли найдёте.

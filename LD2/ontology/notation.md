...
### 2
попросил ссылки ...  (см. doc файл)    
К сожалению, я не могу встроить в сообщение интерактивные кнопки для копирования, как вы просили. Однако я могу подготовить для вас весь список ссылок в виде готового Markdown-кода, который вы сможете легко скопировать и использовать.

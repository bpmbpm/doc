...
*   **BPMN (BPMN Based Ontology, BBO)**: Формализация фрагмента BPMN 2.0 на OWL, разработанная для семантического анализа процессов. Прямые ссылки на саму онтологию пока недоступны, но вы можете использовать инструмент, транслирующий XML-модели BPMN в OWL (см. раздел "Инструменты и трансформации").

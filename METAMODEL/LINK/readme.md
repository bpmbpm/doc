...
#### Issue1
Условие1. Есть две ИТ-системы: Система1 и Система2, которые связаны через Линк1 и Линк2. Обе системы имеют тип "Система". Оба линка имеют тип "Линк". Линк1 имеет свойство protocol = JDBC. Линк2 имеет свойство protocol = ODBC.  
...
В сводной табличке сравни все четыре формализации ро различным критериям. 

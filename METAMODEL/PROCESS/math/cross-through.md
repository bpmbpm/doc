...
### 2.3 E2Ev1 & E2Ev2
Сквозные процнссы - это просто группирорвка. Возможен такой подход для формировании общей карты (пазла) всех верхнеуровневых процессов компании, где проблема не только выделить сквозной процесс, но и назначить на него и владельца (проблема показана в НаФактический владелец процесса).  

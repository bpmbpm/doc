...
- Сквозные (end-to-end) процессы нарезают так, как этго удобно для классификации \ учета \ контроля и т.п. Например, в банках никому в голову не придет сквозной процесс нарезать: от привлечения средств во вклад до выдачи (другому клиенту) кредита. БУдут всегда процессы привлечения и размещения средсвт нарезать отдельно, хотя без (предварительного) привлечения ничего размещать комерческому банку не получится (только центробанк может напечатать и выдать без привлечения).  

...
### V2
Исправь с учтём того, что не может быть выход не финального под процесса иметь результат из каталога продуктов и сквозной процесс может быть моно-функциональным (не кросс-функциональным), т.е. проверку на различие функций нужно убрать.  

Нет. Есть условие, что продукт только на функции end_finish, т.е. если промежуточный подпроцесс  имеет продукт из каталога продуктов, то это не e2ev2. Таким образом, моно функциональный не станет никогда сквозным.

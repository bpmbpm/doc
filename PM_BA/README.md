...
- [Запускаем новый проект: пошаговое руководство для руководителя](https://habr.com/ru/companies/teamly/articles/977396/)
...
- [Единая платформа для проектного офиса: как выбрать под задачи команды](https://habr.com/ru/companies/teamly/articles/972468/)
### Also
- https://github.com/bpmbpm/doc/tree/main/IT/BOK

### digest
- [Управление проектами: дайджест публикаций #46](https://habr.com/ru/articles/972618/) Автор с иронией сжимает PMBoK до «мини‑версии» из пяти блоков: 1) инициация 

### 3
- [За кулисами требований: психоанализ стейкхолдеров для продвинутых аналитиков](https://habr.com/ru/articles/986884/)
- [Как выявлять саботаж стейкхолдеров в ИТ‑проектах и сохранить внедрение под контролем](https://habr.com/ru/companies/otus/articles/1071430/)

### project vs process
- [Геометрия управления](https://habr.com/ru/articles/1069460/)

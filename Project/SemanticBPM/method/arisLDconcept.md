...
В шаблоне "зашита" семантика, которую RDF-парсер к конкретному формату (visio, drawio, yEd и т.п.) преобразует в RDF. Справедливо и обратное, это уже [AutoVAD from rdf](https://github.com/bpmbpm/SemanticBPM?tab=readme-ov-file#autovad-from-rdf) 

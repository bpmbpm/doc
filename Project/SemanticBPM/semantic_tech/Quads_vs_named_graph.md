...
На картинке VAD должен быть нарисован один квадратик-кораблик (процесс) "ремонт трубы", а под ним исполнитель(и) процесса. Но тут исполнитель разветвляется и их будет два в зависимости от условия. Как это показать графически в VAD и сответсвующим триплетом? 

...
- К общему представлению семантики, понятю "знание" и семантики в бизнес-процессах [Иллюстрации](https://github.com/bpmbpm/doc/blob/main/BPM/semantic/README.md) и в целом папка [doc/BPM/semantic]https://github.com/bpmbpm/doc/tree/main/BPM/semantic)

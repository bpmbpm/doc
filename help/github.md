...
- Reverts В нижней части PR кнопка [Отменить изменения](https://docs.github.com/ru/pull-requests/collaborating-with-pull-requests/incorporating-changes-from-a-pull-request/reverting-a-pull-request).
### author

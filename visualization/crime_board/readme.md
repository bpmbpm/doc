...
- [Как Александр Чачава купил пол-Рунета и как он может повлиять на публичные компании?](https://habr.com/ru/articles/1036600/)
  - Есть ли софт (open source), позволяющий "по кнопке" делать подобные расследования? Перечень промптов с адресами, где искать нужную информацию и т.п.

Или хотя бы алгоритм, как получить ответ "В интересах кого действует Александр?". Про Palantir знаю, но нужно что-то более доступное (бесплатное и простое в использовании).  
Желательно с графовой визуализацией, AI-детективами (ИИ-агентами), т.е. не просто поиск с ручным разбором и дальнейшей ручной обработкой
